...
final class KingBlackDragonCombatStrategy implements CombatStrategy {
    ...
    CombatSessionData attack(CharacterNode character, CharacterNode victim) {
        def data = character.position.withinDistance(victim.position, 2) ? [CombatType.MELEE, CombatType.RANGED, CombatType.MAGIC] : [CombatType.RANGED, CombatType.MAGIC]
